	...
	<div class="g_content">
			<?php 
				...
				if(have_posts()) :
					...
					<div class="bg_title_single" style="background:url('<?php echo BASE_URL; ?>/images/vnexpo_top.jpg')">
						...
						<div class="col-md-9 col-sm-3  content_left">
							<article class="content_single_post">
								<div class="single_post_info">
									...
									<p> 
										<a href="<?php echo home_url(); ?>"><?php if(get_locale() == 'en_US'){?> Home <?php } ?> <?php if(get_locale() == 'vi'){?> Trang chủ <?php }?> > </a>
										<?php	
							...
							<!-- fb-comment-area -->
						<div class="fb-comments" data-href="<?php echo get_permalink();  ?>" data-width="855" data-numposts="20"  data-order-by="reverse_time" data-colorscheme="light"></div>
							...
							<div class="related_posts">
								...
								<ul class="row"> 
									...
									if( $related ) foreach( $related as $post ) {
										setup_postdata($post); ?>
										<li class="col-md-4 col-sm-4 col-xs-12 <?php if(in_category(30) || in_category(28)){echo 'bg_seventy';} ?>"  >
